...
//! 増やしても同じことを 4 回測るだけである (`px-calib direction` で確かめてある) ．
...
/// 実素材のシルエットへ陰影を導出した «`px shade` の出力» を作る．
...
///
/// 横成分のある光源を宣言した `px shade` の出力は，反転すると**必ず**矛盾する．
