...
//! `pxsmith-io/examples/degrade.rs` で，**JPEG 圧縮の水準はここで足した**．
//!
//! | 要因 | 水準 |
//! | --- | --- |
//! | 拡大率 $s$ | 2, 3, 4, 6, 8, 12 |
...
impl Degradation {
    ...
    /// $-d_x \bmod s$ に来る．`pxsmith conform` の位相はセルの開始位置なので
...
#[cfg(test)]
mod tests {
    use pxsmith_core::grid::{GridParams, downscale_modal, estimate_grid};
