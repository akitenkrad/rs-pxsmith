...
//! [`crate::geom`] と `pxsmith shade` が持つ — ここは «$n$ が与えられたときに何色になるか»
//! だけを引き受ける．
//!
...
pub struct ShadeOptions {
    ...
    ///
    /// **4 群で測って 0.25 に決めた** (`pxsmith-calib ao`) ．lint と同じ作法である．
    ///
...
/// 環境遮蔽の閾値の既定 (`pxsmith shade --ao`)．**4 群で測って決めた**
...
/// **`pxsmith shade` の実体** — シルエットへ陰影を付け，キャンバスとパレットを返す．
///
