//! **`pxsmith atmos` を実素材に掛けて «壊していないか» を測る．**
//!
...
use pxsmith_core::atmos::{AtmosOptions, AtmosReport, HazeTable, atmos};
use pxsmith_core::canvas::{IndexedCanvas, RgbaCanvas};
use pxsmith_core::color::{Rgba8, distance_sq, oklab_of};
use pxsmith_core::frame::{Depth, Frame, Layer, LayerMeta, Surface};
