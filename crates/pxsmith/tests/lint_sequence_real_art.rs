...
//!
//! `pxsmith shade` の自己整合性試験 (D58) と同じ性質の検査である．落ちた場合の直し方も
...
//! | `pxsmith anim tween` | 中割り 3 枚 | 23 ・24 ・25 (22 は列しだい) |
//! | `pxsmith anim squash` | 潰しと伸ばし | **23 ・25** — 変形はルール 27 の持ち場である |
//!
...
use pxsmith_core::deform::{SquashOptions, squash};
use pxsmith_core::frame::{Frame, FrameKind, Layer, LayerMeta, Surface};
use pxsmith_core::geom::Mask;
use pxsmith_core::math::{IRect, IVec2, ivec2, uvec2};
...
use pxsmith_lint::{Report, lint_sequence};
...
/// **`pxsmith anim tween` の出力が自分の検査に落ちないこと．**
///
...
/// **`pxsmith anim squash` の出力が «揺れる線» と «孤立列» に落ちないこと．**
///
