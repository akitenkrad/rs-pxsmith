//! **`pxsmith outline` を本物のドット絵に掛けて «壊していないか» を見る．**
//!
//! `pxsmith-core` 側の試験は合成した四角で «描けること» を見ている．ここで見るのは逆で，
...
//!
//! 全件の集計は `pxsmith-calib outline` にある (4 分類 x 61 枚で 2 度目 0 ・blocking 増 0)．
