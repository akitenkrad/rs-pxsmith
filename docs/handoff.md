...
- 更新: 2026-08-15 (**M0 〜 M7 完了．M6 は本物の API で通った (D162)．
  付録 C は全 5 件が閉じた．**R22 も D170 で閉じた** — 円板は «守らない» を選んだ)
...
| ブランチ | `main` |
| コミット | **D162 〜 D171 はすべてコミット済み．作業ツリーはきれい** (最後のコミットは `git log -1` で見る — 番号をここに書くと自分を追いかける) |
